                ...
                success: function (result) {
                    ...
                    for (var i = 0; i < obj.data.length; i++) {
                        ...
                        html += '<ul class="rows even">' +
                            ...
                            '<a href="adminupdate.jsp?id=' + auction.auctionId + '" title="竞拍">修改</a>' +
                            '<a href="javascript:todel(' + auction.auctionId + ')" title="竞拍" onclick="abc();">删除</a></li>' +
                            '</ul>';
                    }
                    var pagenum = '';
                    var ii = 0;
...
<div class="wrap">
    ...
    <div class="forms">
        ...
        <input type="button" value="发布" class="spbg buttombg f14  sale-buttom buttomb"
               onclick="javascript:location.href='adminadd.jsp'"/>
    </div>
    <div class="items">
